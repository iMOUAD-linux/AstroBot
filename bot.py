    ...
    if militesRole:
        ...
        if militesChannel:
            embed = discord.Embed(
                ...
                description=member.mention + " This is what you need to do as a **Milite** on ARENA.",
            ...
            embed.add_field(name="3. Rise to Warrior", value=f"Reach 1000xp to be a {discord.utils.get(ctx.guild.roles, id=1438574168269525105).mention}, This makes you an official combatant in our **ARENA**.", inline=False)
...
XP_VALUES = {
    "<:etoile:1444804986788647064>": 10,   # 1 star
    "<:2etoiles:1444804988512632843>": 20,   # 2 stars
    "<:3etoiles:1444804990475702282>": 30,   # 3 stars
    "<:4etoiles:1444804993147338874>": 40,   # 4 stars
    "<:cinqetoiles:1444804995156283614>": 50,   # 5 stars
}
